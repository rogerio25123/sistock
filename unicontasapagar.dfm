object frmcontasapagar: Tfrmcontasapagar
  ...
  object GroupBox1: TGroupBox
    ...
    object editvencimento: TDateTimePicker
      ...
      Width = 121
      Height = 21
      Date = 40363.167885196760000000
      Time = 40363.167885196760000000
      TabOrder = 0
    end
  end
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 359
    Align = alBottom
    DataSource = dm2.srccontasapagar
  ...
  object sqlultimacontas: TZQuery
    Connection = dm2.conexao
    SQL.Strings = (
      'SELECT MAX( codigo + 1 ) maximoconta  FROM contasapagar')
    Params = <>
    Left = 272
    Top = 120
    object sqlultimacontasmaximoconta: TLargeintField
      FieldName = 'maximoconta'
      ReadOnly = True
    end
  end
end
