object frmviscaixa: Tfrmviscaixa
  Left = -4
  Top = -4
  Width = 1288
  Height = 772
  Caption = 'Administra'#231#227'o das Vendas'
  Color = clBtnFace
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      item
        Text = 'F10 - Cancelar Notas Abertas'
        Width = 180
      end
      item
        Text = 'F12 - Cancelar Notas Fechadas com Estorno'
        Width = 50
      end>
  end
  object PopupMenu1: TPopupMenu
    ...
    object CancelarNotasFechadacomEstorno1: TMenuItem
      Caption = 'Cancelar Notas Fechada com Estorno'
      ShortCut = 123
      OnClick = CancelarNotasFechadacomEstorno1Click
    end
  end
  object sqltotalgrupo: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  sum(total)  as totalgrupo,formapgto, vendedor from dados' +
        'vendas  group by vendedor, formapgto')
    Params = <>
    Left = 464
    Top = 67
    ...
    object sqltotalgrupovendedor: TStringField
      FieldName = 'vendedor'
      Size = 40
    end
  end
