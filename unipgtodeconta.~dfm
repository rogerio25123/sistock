object frmpgtodeconta: Tfrmpgtodeconta
  Left = 258
  Top = 155
  Width = 699
  Height = 578
  ...
  object PopupMenu1: TPopupMenu
    Left = 384
    Top = 256
    object ZerarConta1: TMenuItem
      Caption = 'Eliminar pgto(s) e vendas da  Conta do Cliente'
      ShortCut = 119
      OnClick = ZerarConta1Click
    end
  end
end
